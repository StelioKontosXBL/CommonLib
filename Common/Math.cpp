...
/*
Functions TriangleInscribedCircle and TriangleCircumscribedCircle are based on nVidia SDK, modu³ nv_algebra.
*/
...
{
	// To by³o le! Nie wiem sk¹d siê to wziê³o, ale zgodnie z ksi¹¿k¹
...
// == Do klasy QUATERNION ==
// Wersja stara sprzed odwrócenia kolejnoci:
...
{
	// Kwaternion identyczniociowy ma daæ w wyniku ten sam kwaternion,
...
Porównanie zgodnoci wyników moich funkcji z D3DXQuaternionSlerp dla losowych
kwaternionów:
...
void FRUSTUM_POINTS::CalcCenter(VEC3 *Out) const
{
	...
	// Punkt w po³owie odleg³oci miêdzy nimi to rodek sfery
...
void FRUSTUM_POINTS::CalcBoundingSphere(VEC3 *SphereCenter, float *SphereRadius) const
{
	...
	// Promieñ sfery to odleg³oæ tego punktu od jakiego punktu z rogu far clipping plane
...
/*
Wersja stara, która liczy le! Nie wiem sk¹d pochodzi.
...
{
	// To jest uniwersalny algorytm na kolizjê promienia/prostej/odcinka z wielocianem wypuk³ym.
...
ale jeli siê nigdzie nie pomyli³em przy zamianie wspó³rzêdnych przy kopiowaniu to powinna dzia³aæ wszêdzie.
*/
bool RayToPolygon(
	const VEC3 &RayOrig, const VEC3 &RayDir,
	const void *PolygonPoints, size_t PolygonPointCount, ptrdiff_t PolygonPointStride,
	...
	float *OutT1, float *OutT2)
{
	...
	// Dzia³a w oparciu o jakietam równanie kwadratowe.
...
{
	// Dla szecianu (-1,-1,-1)..(1,1,1) objêtoæ to 8, dla sfery o promieniu 1 objêtoæ to 4/3*PI ~= 4.18.
...
void RandomPointInCapsule(VEC3 *Out, const VEC3 &p1, const VEC3 &p2, float R, RandomGenerator &Rand)
{
	...
	// Prawdopodobieñstwo wylosowania z kuli jest proporcjonalne do stosunku objêtoci kuli do objêtoci walca.
